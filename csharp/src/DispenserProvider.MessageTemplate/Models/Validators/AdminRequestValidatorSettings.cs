...
public class AdminRequestValidatorSettings(string signature, AbstractMessage message, IReadOnlyCollection<long> chainIDs)
{
    public IReadOnlyCollection<long> ChainIDs { get; } = chainIDs;
